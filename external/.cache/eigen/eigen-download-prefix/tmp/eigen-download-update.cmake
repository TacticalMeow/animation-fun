...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      _ep_message_quiet_capture(FATAL_ERROR
        "\nFailed to rebase in: 'C:/Users/edens/source/repos/tamirgrBGU/EngineForAnimationCourse-master/cmake/../external/eigen'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      _ep_accumulate_captured_output()
      _ep_message_quiet_capture(FATAL_ERROR
        "Failed to unstash changes in: 'C:/Users/edens/source/repos/tamirgrBGU/EngineForAnimationCourse-master/cmake/../external/eigen'.\n"
        "You will have to resolve the conflicts manually"
      )
    endif()
  endif()
